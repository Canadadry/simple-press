...
func GetRouter(services Services) (http.HandlerFunc, error) {
	...
	r.Get("/admin/articles/:digit", c.GetArticle)
	r.Post("/admin/articles/:digit/edit/metadata", c.PostArticleEditMetadata)
	r.Post("/admin/articles/:digit/edit/content", c.PostArticleEditContent)
	r.Post("/admin/articles/:digit/edit/block_add", c.PostArticleEditBlockAdd)
	...
	r.Get("/admin/articles/:digit/preview", c.GetArticlePreview)
